...
ActiveRecord::Schema.define(version: 2019_10_27_004508) do
  ...
  create_table "artwork_shares", force: :cascade do |t|
    ...
    t.datetime "created_at", default: "2019-10-27 00:50:05", null: false
    t.datetime "updated_at", default: "2019-10-27 00:50:05", null: false
